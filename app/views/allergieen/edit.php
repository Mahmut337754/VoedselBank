<?php $pageTitle = 'Allergie bewerken - ' . APP_NAME; ?>
    ...
    <div class="row">
        ...
        <main class="col p-4" style="max-width:600px;">
            <div class="d-flex align-items-center gap-2 mb-4">
                ...
                <h5 class="fw-bold mb-0">Allergie bewerken</h5>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="/allergieen/update" novalidate>
                        <input type="hidden" name="id" value="<?= $allergie['wens_id'] ?>">
                        <div class="mb-3">
                            ...
                            <input type="text" name="naam" class="form-control" required maxlength="100"
                                   value="<?= htmlspecialchars($_POST['naam'] ?? $allergie['naam']) ?>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label">Omschrijving</label>
                            <textarea name="omschrijving" class="form-control" rows="3" maxlength="255"><?= htmlspecialchars($_POST['omschrijving'] ?? $allergie['omschrijving'] ?? '') ?></textarea>
                        </div>
