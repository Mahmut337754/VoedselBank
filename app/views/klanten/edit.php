<?php
// Haal eventuele fouten en oude invoer uit sessie
$errors = $_SESSION['errors'] ?? [];
$old = $_SESSION['old_input'] ?? [];

// Gebruik oude invoer als die bestaat, anders de bestaande klantgegevens
$gezinsnaam = $old['gezinsnaam'] ?? $klant['gezinsnaam'];
$telefoon   = $old['telefoon'] ?? $klant['telefoon'];
$email      = $old['email'] ?? $klant['email'];
$adres      = $old['adres'] ?? $klant['adres'];
$postcode   = $old['postcode'] ?? $klant['postcode'];
$plaats     = $old['plaats'] ?? $klant['plaats'];
$volwassenen = $old['aantal_volwassenen'] ?? $klant['aantal_volwassenen'];
$kinderen   = $old['aantal_kinderen'] ?? $klant['aantal_kinderen'];
$babys      = $old['aantal_babys'] ?? $klant['aantal_babys'];

// Wensen: oude selectie of bestaande gekoppelde wensen
$wensenOld = $old['wensen'] ?? $gekozenWensen;
?>
<!DOCTYPE html>
<html lang="nl">
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col p-4">
                ...
                <form action="<?= BASE_URL ?>/klanten/update" method="POST">
                    <input type="hidden" name="id" value="<?= $klant['klant_id'] ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="gezinsnaam"
                                ...
                                value="<?= htmlspecialchars($gezinsnaam) ?>">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" name="telefoon"
                                ...
                                value="<?= htmlspecialchars($telefoon) ?>">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" name="aantal_volwassenen"
                                ...
                                min="1" value="<?= htmlspecialchars($volwassenen) ?>">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" name="aantal_kinderen"
                                ...
                                min="0" value="<?= htmlspecialchars($kinderen) ?>">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" name="aantal_babys"
                                ...
                                min="0" value="<?= htmlspecialchars($babys) ?>">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wensen[]"
                                            ...
                                            <?= in_array($wens['wens_id'], $wensenOld) ? 'checked' : '' ?>>
                    ...
                    <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Bijwerken</button>
    ...
    <?php
    // Verwijder sessiegegevens na gebruik
