<?php $pageTitle = 'Account bewerken - ' . APP_NAME; ?>
    ...
    <div class="row">
        ...
        <main class="col p-4" style="max-width:600px;">
            <div class="d-flex align-items-center gap-2 mb-4">
                ...
                <h5 class="fw-bold mb-0">Account bewerken</h5>
            </div>
            <?php if (!empty($error)): ?>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="/accounts/update" novalidate>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="actief" id="actief"
                                    <?= (isset($_POST['actief']) ? $_POST['actief'] : $user['actief']) ? 'checked' : '' ?>>
                                <label class="form-check-label" for="actief">Account actief</label>
                            </div>
                        </div>
                        <hr>
                        <p class="text-muted small">Laat leeg om wachtwoord ongewijzigd te laten.</p>
                        <div class="mb-3">
