...
// Zorg dat $formData altijd een array is met de huidige gegevens
$formData = $formData ?? [];
...
// Converteer datetime naar formaat voor datetime-local (YYYY-MM-DD\THH:MM)
    ...
    <div class="row">
        ...
        <main class="col p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?= BASE_URL ?>/leveranciers" class="btn btn-outline-secondary">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>/leveranciers/update" novalidate>
                        <input type="hidden" name="id" value="<?= $id ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="bedrijfsnaam" class="form-label">Bedrijfsnaam *</label>
                                <input type="text" class="form-control <?= editErrorClass($fieldErrors, 'bedrijfsnaam') ?>"
                                    id="bedrijfsnaam" name="bedrijfsnaam"
                                    value="<?= editOldValue($formData, 'bedrijfsnaam') ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?= editErrorClass($fieldErrors, 'contactpersoon') ?>"
                                    id="contactpersoon" name="contactpersoon"
                                    value="<?= editOldValue($formData, 'contactpersoon') ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control <?= editErrorClass($fieldErrors, 'email_contact') ?>"
                                    id="email_contact" name="email_contact"
                                    value="<?= editOldValue($formData, 'email_contact') ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?= editErrorClass($fieldErrors, 'telefoon') ?>"
                                    id="telefoon" name="telefoon"
                                    value="<?= editOldValue($formData, 'telefoon') ?>" required>
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control <?= editErrorClass($fieldErrors, 'adres') ?>"
                                    id="adres" name="adres"
                                    value="<?= editOldValue($formData, 'adres') ?>" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control <?= editErrorClass($fieldErrors, 'postcode') ?>"
                                    id="postcode" name="postcode"
                                    value="<?= editOldValue($formData, 'postcode') ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?= editErrorClass($fieldErrors, 'plaats') ?>"
                                    id="plaats" name="plaats"
                                    value="<?= editOldValue($formData, 'plaats') ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control <?= editErrorClass($fieldErrors, 'eerstvolgende_levering') ?>"
                                    id="eerstvolgende_levering" name="eerstvolgende_levering"
                                    value="<?= formatDateTimeLocal($formData['eerstvolgende_levering'] ?? '') ?>" required>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="<?= BASE_URL ?>/leveranciers" class="btn btn-outline-secondary">Annuleren</a>
