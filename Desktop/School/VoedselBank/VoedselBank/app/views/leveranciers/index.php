        ...
        <main class="col p-4">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="<?= BASE_URL ?>/leveranciers/create" class="btn btn-primary">
            ...
            <?php if (!empty($error)): ?>
                <div class="alert alert-danger d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3" role="alert">
                    ...
                    <a href="<?= BASE_URL ?>/leveranciers" class="btn btn-danger">
                                        ...
                                        <?php foreach ($leveranciers as $leverancier): ?>
                                            <tr>
                                                <td class="fw-semibold">
                                                    <a class="text-decoration-none" href="<?= BASE_URL ?>/leveranciers/edit?id=<?= (int)$leverancier['leverancier_id'] ?>">
                                                ...
                                                <td class="text-end">
                                                    <div class="d-inline-flex gap-1">
                                                        <a href="<?= BASE_URL ?>/leveranciers/edit?id=<?= (int)$leverancier['leverancier_id'] ?>" class="btn btn-sm btn-outline-primary">
                                                            <i class="bi bi-pencil-square me-1"></i>Wijzigen
                                                        </a>
                                                        <form method="POST" action="<?= BASE_URL ?>/leveranciers/delete" class="d-inline" onsubmit="return confirm('Weet je zeker dat je deze leverancier wilt verwijderen?');">
