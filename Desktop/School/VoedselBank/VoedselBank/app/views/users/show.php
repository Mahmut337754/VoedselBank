<?php $pageTitle = 'Gebruiker details – ' . APP_NAME; ?>
    ...
    <div class="row">
        ...
        <main class="col p-4" style="max-width:500px;">
            <div class="d-flex align-items-center gap-2 mb-4">
                ...
                <h5 class="fw-bold mb-0">Gebruiker details</h5>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 text-muted"><?= $user['gebruiker_id'] ?></dd>
                        ...
                        <dd class="col-sm-8">
                            <span class="badge bg-secondary"><?= htmlspecialchars($user['rolnaam']) ?></span>
                        </dd>
                ...
                <div class="card-footer bg-transparent d-flex gap-2">
                    <a href="/users/edit?id=<?= $user['gebruiker_id'] ?>" class="btn btn-primary btn-sm">
                        <i class="bi bi-pencil me-1"></i> Bewerken
                    </a>
                    <?php if ($user['gebruiker_id'] != $_SESSION['user_id']): ?>
                    <a href="/users/delete?id=<?= $user['gebruiker_id'] ?>"
